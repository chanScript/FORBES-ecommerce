        ...
        <FilterSection title="Price Range" expanded={expandedSections.price} onToggle={() => toggleSection('price')}>
          <div className="flex gap-2">
            <input
              ...
              className="w-1/2 rounded-lg border border-gray-200 px-3 py-2 text-sm focus:border-primary-accent focus:outline-none focus:ring-1 focus:ring-primary-accent"
            />
            <input
              type="number"
              placeholder="Max"
