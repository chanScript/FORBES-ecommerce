        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div class="lg:col-span-1">
            ...
            <div class="flex gap-3">
              <a href="https://facebook.com/profile.php?id=61584665866351" target="_blank" rel="noopener noreferrer" class="w-9 h-9 bg-primary-800 hover:bg-accent rounded-lg flex items-center justify-center transition-colors"><i data-lucide="facebook" class="w-4 h-4 text-gray-400"></i></a>
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" class="w-9 h-9 bg-primary-800 hover:bg-accent rounded-lg flex items-center justify-center transition-colors"><i data-lucide="linkedin" class="w-4 h-4 text-gray-400"></i></a>
              <a href="mailto:rsalas@forbesfinancial.com.ph" class="w-9 h-9 bg-primary-800 hover:bg-accent rounded-lg flex items-center justify-center transition-colors"><i data-lucide="mail" class="w-4 h-4 text-gray-400"></i></a>
              <a href="https://tiktok.com/@ffcc.ortigas" target="_blank" rel="noopener noreferrer" class="w-9 h-9 bg-primary-800 hover:bg-accent rounded-lg flex items-center justify-center transition-colors"><i data-lucide="music" class="w-4 h-4 text-gray-400"></i></a>
            </div>
          </div>
          <div>
